...
class Inform_DelightPZ(CatInformer):
    ...
    config_options.update(dlght_redshiftMin=Param(float, 0.01, msg='min redshift'),
                          ...
                          bands_path=Param(str, os.path.join(RAILDIR, "rail/examples/estimation/data/FILTER"), msg='string specifying path to filter directory'),
                          ...
                          tempdir=Param(str, "rail/examples/estimation/tmp", msg='temp dir'),
                          tempdatadir=Param(str, "rail/examples/estimation/tmp/delight_data", msg='temp data dir'),
                          sed_path=Param(str, os.path.join(RAILDIR, "rail/examples/estimation/data/SED"), msg='path to SED dir'),
                          ...
                          dlght_inputdata=Param(str, os.path.join(RAILDIR, "rail/examples/estimation/tmp/delight_indata"), msg="input data directory for ascii data"),
